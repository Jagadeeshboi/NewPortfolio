...
function Contact() {
    ...
    <section className="bg-[#1a1a1a] h-full w-full rounded-2xl mt-16 lg:mt-24">
    <div className="container px-6 py-12 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-6">
            <div className="lg:w-1/2 lg:mx-6">
                <h1 className="text-2xl font-semibold text-gray-300 capitalize:text-3xl">
                    Contact me for <br/> more info
                </h1>

                <div className="mt-6 space-y-8 md:mt-8">
                    <p className="flex items-start -mx-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-orange-500 " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>

                        <span className="mx-2 text-gray-400 truncate whitespace-normal ">
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-400 truncate ">(+91) 7680023449</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-400 truncate">jagadeeshboina@gmail.com</span>
                    </p>
                </div>

                <div className="mt-6 md:mt-8">
                    <h3 className="text-gray-400 ">Follow Me</h3>

                    <div className="flex mt-4 -mx-1.5 ">
                        <a className="mx-1.5ange-400 text-gray-400 transition-colors duration-300 transform hover:text-orange-500" href="https://www.linkedin.com/in/jagadeesh-boina/" target="_blank">
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
                <div
                    className="w-full px-8 py-10 mx-auto overflow-hidden bg-black rounded-lg shadow-2xl  lg:max-w-xl shadow-gray-300/5050">
